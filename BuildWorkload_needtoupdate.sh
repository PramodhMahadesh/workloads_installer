...
cmake -DREGISTRY=amr-registry.caas.intel.com/sf-cwr -DRELEASE=v23.17.6 -DPLATFORM=GNR -DTERRAFORM_SUT='static' -DBENCHMARK= -DTERRAFORM_OPTIONS="--native --docker --intel_publish --svrinfo --owner=mahadesx" ..
